...

{
  ...
  options = {
    ...
    services.munin-cron = {
      ...
      fastcgi = {
        enableGraph = lib.mkEnableOption "Enable systemd service for munin-cgi-graph";

        enableHtml = lib.mkEnableOption "Enable systemd service for munin-cgi-html";
  ...
  config = lib.mkMerge [
    ...
    (lib.mkIf (cronCfg.enable && cronCfg.fastcgi.enableGraph) {
    ...
    (lib.mkIf (cronCfg.enable && cronCfg.fastcgi.enableHtml) {
